    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(user.equals("")){
                    username.setError("lütfen bilgileri doldurunuz");
                }
                else if(pass.equals("")){
                    password.setError("lütfen bilgileri doldurunuz");
                }
                else{
                            ...
                            if(s.equals("null")){
                                ...
                                try {
                                    ...
                                    if(!obj.has(user)){
                                        ...
                                        Toast.makeText(Login.this, "şifre yanlış", Toast.LENGTH_LONG).show();
                                    }
